...
public class AccountsDAOImpl implements AccountsDAO {
    ...
    public List<Account> getAll() {
        try (Connection conn = sql2o.open()) {
            return conn.createQuery("SELECT accountId, name, active, created, accountbalance.balance FROM account LEFT JOIN accountbalance ON account.accountId = accountbalance.accountId")
